...
<section class="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-dark-50 via-white to-primary-50">
  <div class="absolute inset-0 bg-gradient-to-br from-dark-50 via-white to-primary-100/60"></div>
...
<!-- ==================== ROOMS SECTION ==================== -->
<section id="rooms" class="py-24 bg-dark-100/60">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <span class="text-primary-600 text-sm font-semibold uppercase tracking-wider">Our Spaces</span>
      <h2 class="text-3xl md:text-4xl font-bold text-dark-900 mt-2 mb-4">Rooms Built for Success</h2>
...
<!-- ==================== ABOUT / WHY CHOOSE US ==================== -->
<section id="about" class="py-24 bg-dark-100/60">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div>
        <span class="text-primary-600 text-sm font-semibold uppercase tracking-wider">Why Choose Us</span>
        <h2 class="text-3xl md:text-4xl font-bold text-dark-900 mt-2 mb-6">A Collaborative Environment with a Thriving Community</h2>
        ...
        <div class="space-y-6">
          <div class="flex gap-4">
            ...
            <div>
              <h3 class="text-dark-900 font-semibold mb-1">Flexible Scheduling</h3>
              <p class="text-sm text-dark-500">Book by the day, week, or month. Choose the plan that fits your workflow.</p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              <h3 class="text-dark-900 font-semibold mb-1">Modern Equipment</h3>
              <p class="text-sm text-dark-500">4K displays, video conferencing, wireless screen sharing, and high-speed WiFi.</p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              <h3 class="text-dark-900 font-semibold mb-1">Professional Environment</h3>
              <p class="text-sm text-dark-500">Impress your clients in our premium, well-maintained spaces with all amenities included.</p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              <h3 class="text-dark-900 font-semibold mb-1">On-Site Convenience</h3>
              <p class="text-sm text-dark-500">Kitchen access, parking, and everything you need in one location.</p>
            </div>
          </div>
        </div>
      </div>
...
<section id="location" class="py-24 bg-dark-100/60">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div>
        <span class="text-primary-600 text-sm font-semibold uppercase tracking-wider">Find Us</span>
        <h2 class="text-3xl md:text-4xl font-bold text-dark-900 mt-2 mb-6">Conveniently Located</h2>
        <p class="text-dark-600 mb-8 leading-relaxed">
        ...
        <div class="space-y-4">
          <div class="flex items-start gap-4">
            <div class="flex-shrink-0 w-10 h-10 bg-primary-50 rounded-lg flex items-center justify-center border border-primary-100">
            ...
            <div>
              <h3 class="text-dark-900 font-medium">Address</h3>
              <p class="text-sm text-dark-500">123 Business Street, Melbourne VIC 3000</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-dark-900 font-medium">Phone</h3>
              <p class="text-sm text-dark-500">(03) 0000 0000</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-dark-900 font-medium">Hours</h3>
              <p class="text-sm text-dark-500">Monday - Friday: 7:00 AM - 7:00 PM</p>
              <p class="text-sm text-dark-500">Monthly members: 24/7 access</p>
            </div>
          </div>
        </div>
      </div>

      <div class="h-[400px] rounded-xl overflow-hidden border border-dark-200">
...
<section class="py-24">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="relative bg-gradient-to-r from-primary-600 to-primary-800 rounded-2xl p-12 text-center overflow-hidden shadow-xl">
