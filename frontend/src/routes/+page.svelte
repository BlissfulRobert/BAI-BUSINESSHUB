...
<!-- ==================== HERO SECTION ==================== -->
<section
  class="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-dark-50 via-white to-primary-50"
>
  <div class="absolute inset-0 bg-white"></div>
  <div
    class="absolute top-0 right-0 w-[600px] h-[600px] bg-primary-200/40 rounded-full blur-3xl"
  ></div>
  <div
    class="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gold-400/20 rounded-full blur-3xl"
  ></div>
  <div
    class="absolute bottom-[-2px] left-0 right-0 h-16 bg-primary-800"
  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="grid grid-cols-1 lg:grid-cols-[5fr_4fr] gap-12 items-center">
      <div>
        <div
          class="inline-flex items-center gap-2 bg-primary-50 border border-primary-200 rounded-full px-4 py-1.5 mb-6"
        >
        ...
        <h1
          class="text-4xl md:text-5xl lg:text-6xl font-bold text-dark-900 leading-tight mb-6"
        >
          Premium Workspaces
        ...
        <div class="flex flex-wrap gap-4">
          <a
            href="#rooms"
            class="bg-primary-600 hover:bg-primary-700 text-white font-medium px-8 py-3 rounded-lg transition-colors duration-200"
          >
            View Rooms
          </a>
          <a
            href="#plans"
            class="border border-dark-300 text-dark-700 hover:bg-dark-100 font-medium px-8 py-3 rounded-lg transition-colors duration-200"
          >
            See Plans
          </a>
        </div>
        ...
        <div
          class="flex items-center gap-8 mt-12 pt-8 border-t border-dark-200"
        >
          <div>
      ...
      <div class="relative hidden lg:block lg:-mr-16 lg:mt-20">
        <div
          class="aspect-[4/3] bg-white rounded-2xl overflow-hidden border border-dark-200 shadow-2xl"
        >
          {#if rooms.length > 0}
            <img
              src={getRoomImage(rooms[0].name)}
              alt={rooms[0].name}
              class="w-full h-full object-cover"
            />
          {:else}
            <div
              class="w-full h-full flex items-center justify-center bg-gradient-to-br from-dark-200 to-dark-300"
            >
              <div class="text-center">
                <svg
                  class="w-20 h-20 text-dark-400 mx-auto mb-4"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div
          class="absolute -bottom-8 -left-8 bg-white border border-dark-200 rounded-xl p-4 shadow-xl"
        >
...
<section
  id="rooms"
  class="py-24 bg-gradient-to-br from-primary-800 via-primary-700 to-primary-900"
>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-16 lg:max-w-2xl">
      <div class="flex items-center gap-3 mb-4">
        ...
        <span
          class="text-primary-200 text-sm font-semibold uppercase tracking-wider"
          >Our Spaces</span
        >
      </div>
      <h2 class="text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
        Rooms Built for Success
      </h2>
      <p class="text-primary-100">
        From intimate meetings to large-scale presentations, our professionally
        designed rooms provide the perfect environment for your business.
      </p>
    </div>
...
<section id="plans" class="py-24">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-[2fr_9fr] gap-12 items-start">
      <div class="lg:pr-8">
        <span
          class="text-primary-600 text-sm font-semibold uppercase tracking-wider"
          >Pricing</span
        >
        <h2
          class="text-3xl md:text-4xl font-bold text-dark-900 mt-2 mb-4 leading-tight"
        >
          Flexible Plans for Every Need
        </h2>
        <p class="text-dark-500 leading-relaxed">
          Choose the plan that works for you. All plans include access to our
          premium amenities. Payment is made on-site.
        </p>
      </div>
      ...
      <div>
        ...
        <p class="mt-8 text-sm text-dark-500">
          All payments are processed on-site. Cancellations are allowed but
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-16 items-start">
      <div>
        ...
        <h2 class="text-3xl md:text-4xl font-bold text-white mt-2 mb-6">
          A Collaborative Environment with a Thriving Community
        </h2>
        <p class="text-primary-100 mb-8 leading-relaxed">
          BAI Business Hub is more than just a workspace. We provide a
          professional environment designed to help you and your business
          prosper. From quiet focused zones to vibrant collaborative areas, our
        ...
        <div class="space-y-6">
          <div class="flex gap-4">
            <div
              class="flex-shrink-0 w-12 h-12 bg-white/15 rounded-xl flex items-center justify-center border border-white/20"
            >
              <svg
            ...
            <div>
              ...
              <p class="text-sm text-primary-100">
                Book by the day, week, or month. Choose the plan that fits your
                workflow.
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-primary-100">
                4K displays, video conferencing, wireless screen sharing, and
                high-speed WiFi.
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-primary-100">
                Impress your clients in our premium, well-maintained spaces with
          ...
          <div class="flex gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-primary-100">
                Kitchen access, parking, and everything you need in one
                location.
              </p>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="space-y-4">
              {#each reviews.slice(0, 3) as review}
                <div
                  class="border-b border-dark-200 last:border-0 pb-4 last:pb-0"
                >
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <span
        ...
        >Gallery</span
      >
      <h2 class="text-3xl md:text-4xl font-bold text-dark-900 mt-2 mb-4">
        See Our Spaces
      </h2>
      <p class="text-dark-500 max-w-2xl mx-auto">
        Take a virtual tour of our premium facilities and see why members love
        working here.
      </p>
    </div>
...
<section
  id="location"
  class="py-24 bg-gradient-to-br from-primary-800 via-primary-700 to-primary-900 overflow-hidden"
>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-12 items-start">
      <div>
        ...
        <p class="text-primary-100 mb-8 leading-relaxed">
          BAI Business Hub is easily accessible with nearby parking and public
          transport options. Visit us today and see our spaces in person.
        </p>

        <div class="space-y-4">
          <div class="flex items-start gap-4">
            <div
              class="flex-shrink-0 w-10 h-10 bg-white/15 rounded-lg flex items-center justify-center border border-white/20"
            >
              <svg
...
<BookingModal bind:isOpen={bookingModalOpen} room={selectedRoom} {plans} />

<!-- ==================== CTA SECTION ==================== -->
<section class="py-20">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div
      class="relative bg-gradient-to-r from-primary-700 to-primary-900 rounded-2xl px-8 sm:px-12 py-12 lg:py-16 overflow-hidden shadow-xl"
    >
      <div
        class="absolute top-0 right-0 w-64 h-64 bg-gold-500/20 rounded-full blur-3xl"
      ></div>
      <div
        class="relative grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8 items-center"
      >
        <div>
          ...
          <p class="text-primary-100 max-w-xl leading-relaxed">
            Join BAI Business Hub today and experience premium workspaces
            designed for your success.
          </p>
        </div>
        <div
          class="flex flex-col sm:flex-row lg:flex-col lg:justify-center gap-4"
        >
          <a
            href="/auth/register"
            class="bg-white text-primary-700 font-medium px-8 py-3 rounded-lg text-center transition-colors duration-200 hover:bg-primary-50"
          >
            Create Account
          </a>
          <a
            href="#plans"
            class="border border-primary-200 text-white font-medium px-8 py-3 rounded-lg text-center transition-colors duration-200 hover:bg-primary-700"
          >
            View Plans
          </a>
        </div>
